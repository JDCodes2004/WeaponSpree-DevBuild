...
namespace Quantum.Prototypes {
  ...
  public unsafe partial class GameplayPrototype : ComponentPrototype<Quantum.Gameplay> {
    ...
    public void Materialize(Frame frame, ref Quantum.Gameplay result, in PrototypeMaterializationContext context = default) {
        ...
        result.GameDuration = this.GameDuration;
        result.DoubleDamageDuration = this.DoubleDamageDuration;
        result.PlayerRespawnTime = this.PlayerRespawnTime;
  ...
  public unsafe partial class HealthPrototype : ComponentPrototype<Quantum.Health> {
    ...
    public void Materialize(Frame frame, ref Quantum.Health result, in PrototypeMaterializationContext context = default) {
        ...
        result.SpawnImmortalityTime = this.SpawnImmortalityTime;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.HealthPickup))]
  public unsafe partial class HealthPickupPrototype : StructPrototype {
    public FP Heal;
    partial void MaterializeUser(Frame frame, ref Quantum.HealthPickup result, in PrototypeMaterializationContext context);
    public void Materialize(Frame frame, ref Quantum.HealthPickup result, in PrototypeMaterializationContext context = default) {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.LagCompensationProxy))]
  public unsafe partial class LagCompensationProxyPrototype : ComponentPrototype<Quantum.LagCompensationProxy> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.LagCompensationProxy result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.LagCompensationProxy component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.LagCompensationProxy result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class PickupPrototype : ComponentPrototype<Quantum.Pickup> {
    ...
    partial void MaterializeUser(Frame frame, ref Quantum.Pickup result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.Pickup component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.Pickup result, in PrototypeMaterializationContext context = default) {
        this.Settings.Materialize(frame, ref result.Settings, in context);
        result.PickupCooldown = this.PickupCooldown;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.PickupSettings))]
  public unsafe partial class PickupSettingsPrototype : UnionPrototype {
    public string _field_used_;
    public Quantum.Prototypes.HealthPickupPrototype Health;
    public Quantum.Prototypes.WeaponPickupPrototype Weapon;
    partial void MaterializeUser(Frame frame, ref Quantum.PickupSettings result, in PrototypeMaterializationContext context);
    public void Materialize(Frame frame, ref Quantum.PickupSettings result, in PrototypeMaterializationContext context = default) {
        switch (_field_used_) {
          case "HEALTH": this.Health.Materialize(frame, ref *result.Health, in context); break;
          case "WEAPON": this.Weapon.Materialize(frame, ref *result.Weapon, in context); break;
  ...
  public unsafe partial class PlayerPrototype : ComponentPrototype<Quantum.Player> {
    ...
    public void Materialize(Frame frame, ref Quantum.Player result, in PrototypeMaterializationContext context = default) {
        ...
        result.CameraOffset = this.CameraOffset;
  ...
  public unsafe partial class WeaponPrototype : ComponentPrototype<Quantum.Weapon> {
    ...
    public void Materialize(Frame frame, ref Quantum.Weapon result, in PrototypeMaterializationContext context = default) {
        ...
        result.ClipAmmo = this.ClipAmmo;
        result.MaxClipAmmo = this.MaxClipAmmo;
        result.RemainingAmmo = this.RemainingAmmo;
        result.MaxRemainingAmmo = this.MaxRemainingAmmo;
        result.ReloadTime = this.ReloadTime;
        result.Damage = this.Damage;
        result.FireRate = this.FireRate;
        result.ProjectilesPerShot = this.ProjectilesPerShot;
        result.Dispersion = this.Dispersion;
        result.MaxHitDistance = this.MaxHitDistance;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.WeaponPickup))]
  public unsafe partial class WeaponPickupPrototype : StructPrototype {
    public Byte WeaponID;
    public Int32 RefillAmmo;
    partial void MaterializeUser(Frame frame, ref Quantum.WeaponPickup result, in PrototypeMaterializationContext context);
    public void Materialize(Frame frame, ref Quantum.WeaponPickup result, in PrototypeMaterializationContext context = default) {
        result.WeaponID = this.WeaponID;
        result.RefillAmmo = this.RefillAmmo;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class WeaponsPrototype : ComponentPrototype<Quantum.Weapons> {
    ...
    public AssetRef<EntityPrototype>[] WeaponPrototypes = new AssetRef<EntityPrototype>[4];
    ...
    public void Materialize(Frame frame, ref Quantum.Weapons result, in PrototypeMaterializationContext context = default) {
        for (int i = 0, count = PrototypeValidator.CheckLength(WeaponPrototypes, 4, in context); i < count; ++i) {
          *result.WeaponPrototypes.GetPointer(i) = this.WeaponPrototypes[i];
        }
        result.HitMask = this.HitMask;
        result.WeaponSwitchTime = this.WeaponSwitchTime;
        MaterializeUser(frame, ref result, in context);
    }
  }
}

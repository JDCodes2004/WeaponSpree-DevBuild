...
{
	/// <summary>
	/// ProjectileVisual can be used to show projectile flying through the air with hit effect at the end.
	/// Notice this script is a standard MonoBehaviour without any simulation related functionality.
	/// </summary>
